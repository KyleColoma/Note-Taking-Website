        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <div class="hidden md:block">
                                <div class="ml-4 flex items-baseline space-x-4">
                                    ...
                                    <?php else : ?>
                                        ...
                                        <a href="/login" class="<?php echo urlIs("/login") ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white'; ?> rounded-md px-3 py-2 text-sm font-medium">Log In</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="ml-4">
                        <?php if ($_SESSION['user'] ?? false) : ?>
                            <form action="/session" method="POST" class="ml-3">
